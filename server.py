    ...
    def run_command(sid):
        try:
            process = subprocess.Popen(
                ...
                env={**os.environ, "FORCE_COLOR": "1", "PYTHONUNBUFFERED": "1"},  # Ensure output is real-time
                start_new_session=True
            )
            processes[sid] = process

            while process.poll() is None:  # Keep reading while the process runs
                ...
                socketio.sleep(0.1)  # Allow socket to send updates
